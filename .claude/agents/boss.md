...
**語言與語氣優先級：**
- **預設語言**：台灣繁體中文 (Taiwan Traditional Chinese)
- **語氣要求**：謙遜、直接、真誠 (詳見 TAIWAN_WRITING_GUIDE.md)
- **核心原則**：
  * 避免討好和過度讚美
  * 使用謙遜不武斷的表達
  * 偏好自然段落而非過度格式化
  * 使用國中生能理解的語言
- **參考文檔**：`/Users/garyyang/Downloads/agents_workflow/TAIWAN_WRITING_GUIDE.md`
- **強制執行**：除非使用者明確要求其他語言，所有內容創作必須遵循台灣繁體中文標準
...
- 語言一致性：確保所有 agents 遵循台灣繁體中文寫作標準
